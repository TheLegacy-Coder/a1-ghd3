...
**As a note, I will add screenshots later (project still hasn't been finalized).

Resources referenced in code (**will most likely add more as development progresses):
---
